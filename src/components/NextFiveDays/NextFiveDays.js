  ...
  return (
    <Container>
      ...
      >
        ...
        <Col>
          <h3>{props.daily[1].temp.min}&#176;</h3>
          <p>Low</p>
        </Col>
        <Col>
          <h3>{props.daily[1].temp.max}&#176;</h3>
          <p>High</p>
        </Col>
        <Col>
      ...
      >
        ...
        <Col>
          <h3>{props.daily[2].temp.min}&#176;</h3>
          <p>Low</p>
        </Col>
        <Col>
          <h3>{props.daily[2].temp.max}&#176;</h3>
          <p>High</p>
        </Col>
        <Col>
      ...
      >
        ...
        <Col>
          <h3>{props.daily[3].temp.min}&#176;</h3>
          <p>Low</p>
        </Col>
        <Col>
          <h3>{props.daily[3].temp.max}&#176;</h3>
          <p>High</p>
        </Col>
        <Col>
      ...
      >
        ...
        <Col>
          <h3>{props.daily[4].temp.min}&#176;</h3>
          <p>Low</p>
        </Col>
        <Col>
          <h3>{props.daily[4].temp.max}&#176;</h3>
          <p>High</p>
        </Col>
        <Col>
      ...
      >
        ...
        <Col>
          <h3>{props.daily[5].temp.min}&#176;</h3>
          <p>Low</p>
        </Col>
        <Col>
          <h3>{props.daily[5].temp.max}&#176;</h3>
          <p>High</p>
        </Col>
        <Col>
